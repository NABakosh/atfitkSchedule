...
import { parseSchedule, ParsedLesson } from './utils/scheduleParcer.ts'
// ❗ Вам нужно убедиться, что путь к scheduleData.json верен относительно этого скрипта
...
function processAndSaveSchedule() {
	try {
		...
		console.log(`🚀 Начинаем обработку ${rawData.length} строк сырых данных...`)
